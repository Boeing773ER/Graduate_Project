...
plt.plot(date, total_confirmed_case, color='r', label='总确诊人数')
plt.plot(sub_data.date, sub_data.n_l_conf, color='k', label='新增确诊人数')
plt.plot(sub_data.date, sub_data.n_l_asy, color='b', label='新增无症状')
